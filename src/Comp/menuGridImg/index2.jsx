                ...
                <>
                  ...
                  >
                    ...
                    <DirectionAwareHover imageUrl={"https://akmweb.youngjoygame.com/web/gms/image/4d3fe74a2127a30a7a89659731f4eaed.jpg"}>
                      <p className="font-bold text-md">Behind the Making of Heroes Revamp</p>
                    </DirectionAwareHover>
                    <DirectionAwareHover imageUrl={"https://akmweb.youngjoygame.com/web/gms/image/5a16754b4ce0fc949eb3a926cd443c4a.jpg"}>
                      <p className="font-bold text-md">PROJECT NEXT Revamped Equipment Overview</p>
                    </DirectionAwareHover>
                    <DirectionAwareHover imageUrl={"https://akmweb.youngjoygame.com/web/gms/image/c589af0e4df270b2c72a1cf8fd9d100a.png"}>
                      <p className="font-bold text-md">Map Revamp</p>
                    </DirectionAwareHover>
{/* 
                    <img
                  ...
                  <motion.div
                    ...
                    // layoutId={`image-${active.title}-${id}`}
                  >
                     <DirectionAwareHover imageUrl={"https://akmweb.youngjoygame.com/web/gms/image/163db4a75bc30862ab59987768fc828d.jpg"}>
