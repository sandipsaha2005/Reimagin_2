              ...
              {loader ? (
                ...
                <>
                  ...
                  >
                    ...
                    <DirectionAwareHover imageUrl={"https://akmweb.youngjoygame.com/web/gms/image/467ca326a7c293585a4067d115db29fc.jpg"}>
                      <p className="font-bold text-md">TIER2 LEAGUE</p>
                    </DirectionAwareHover>
                    <DirectionAwareHover imageUrl={"https://akmweb.youngjoygame.com/web/gms/image/d98de17efec5e38d21d517633bb4870a.JPEG"}>
                      <p className="font-bold text-md">MPL Tour</p>
                    </DirectionAwareHover>
                    <DirectionAwareHover imageUrl={"https://akmweb.youngjoygame.com/web/gms/image/c3fd69ca709832d6e71a441c14444b2c.png"}>
                      <p className="font-bold text-md">PHASESS</p>
                    </DirectionAwareHover>
{/* 
                    <img
                  ...
                  <motion.div
                    ...
                    // layoutId={`image-${active.title}-${id}`}
                  >
                     <DirectionAwareHover imageUrl={"https://akmweb.youngjoygame.com/web/gms/image/d53f9982c48f2d37413ae174370f828c.png"}>
                      <p className="font-bold text-md">Mobile Legends Premier League</p>
                    </DirectionAwareHover>
                     <DirectionAwareHover imageUrl={"https://akmweb.youngjoygame.com/web/gms/image/4e18b40d1bae4f7313ae9c9a4c3d38a1.jpg"}>
                      <p className="font-bold text-md">Skin Trials MPL</p>
                    </DirectionAwareHover>
                     <DirectionAwareHover imageUrl={"https://akmweb.youngjoygame.com/web/gms/image/15e298dba560573b3f84dee9da7613b0.jpg"}>
                      <p className="font-bold text-md">All Stars Skin MPL</p>
                    </DirectionAwareHover>
                    {/* <img
                      className="rounded-xl"
                      width="320"
