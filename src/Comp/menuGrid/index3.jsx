            ...
            >
              ...
              {loader ? (
                ...
                <>
                  ...
                  width="320"
                  height="220"
                  src="https://www.youtube.com/embed/sH-eFLDwKL0?si=WP9bP-m9x4dw7ukc"
                ...
                <iframe
                  ...
                  width="320"
                  height="220"
                  src="https://www.youtube.com/embed/8j_Fg21hYYI?si=B8W4UIaqjXYpOZOG"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin"
                ...
                <iframe
                  ...
                  width="320"
                  height="220"
                  src="https://www.youtube.com/embed/JTKoJkl3CJ8?si=PIRX6TIiLEcj9Iwf"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin"
                ...
                ></iframe>
                  ...
                  width="320"
                  height="220"
                  src="https://www.youtube.com/embed/GbHD6BjY9YM?si=HBDZcZLAApuQMSRW"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin"
                ...
                <iframe
                  ...
                  width="320"
                  height="220"
                  src="https://www.youtube.com/embed/4U_cddexg2k?si=8s46ujEplYiYrtsK"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin"
        ...
        {cards.map((card, index) => (
          ...
          >
            ...
            {smallIconActive && (
              ...
              >
                 <motion.img
                  src={'https://img.youtube.com/vi/sH-eFLDwKL0/sddefault.jpg'}
                  alt=""
                  className="override-img"
                  variants={imageVariants}
                />
                <motion.img
                  src={'https://img.youtube.com/vi/8j_Fg21hYYI/sddefault.jpg'}
                  alt=""
                  className="override-img"
                  variants={imageVariants}
                />
                <motion.img
                  src={'https://img.youtube.com/vi/JTKoJkl3CJ8/sddefault.jpg'}
                  alt=""
                  className="override-img"
                  variants={imageVariants}
                />
                <motion.img
                  src={'https://img.youtube.com/vi/GbHD6BjY9YM/sddefault.jpg'}
                  alt=""
                  className="override-img"
                  variants={imageVariants}
                />
