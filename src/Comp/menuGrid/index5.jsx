            ...
            >
              ...
              {loader ? (
                ...
                <>
                  ...
                  width="320"
                  height="220"
                  src="https://www.youtube.com/embed/ddSiXMkaqW0?si=vEO1yaFdLlmwjwdm"
                ...
                <iframe
                  ...
                  width="320"
                  height="220"
                  src="https://www.youtube.com/embed/hKsK1uVdfiY?si=fqHm29W7-fxqtGGl"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin"
                ...
                <iframe
                  ...
                  width="320"
                  height="220"
                  src="https://www.youtube.com/embed/XNPECVmpAEM?si=jN9kiMrpO-JmntYN"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin"
                ...
                ></iframe>
                  ...
                  width="320"
                  height="220"
                  src="https://www.youtube.com/embed/V9Rx7KVlzU4?si=4QKBqgKh9I91GK82"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin"
                ...
                <iframe
                  ...
                  width="320"
                  height="220"
                  src="https://www.youtube.com/embed/djuoRgpg0u4?si=30UZFrtCi2_cGpEx"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin"
        ...
        {cards.map((card, index) => (
          ...
          >
            ...
            {smallIconActive && (
              ...
              >
                  <motion.img
                  src={'https://img.youtube.com/vi/ddSiXMkaqW0/sddefault.jpg'}
                  alt=""
                  className="override-img"
                  variants={imageVariants}
                />
                <motion.img
                  src={'https://img.youtube.com/vi/hKsK1uVdfiY/sddefault.jpg'}
                  alt=""
                  className="override-img"
                  variants={imageVariants}
                />
                <motion.img
                  src={'https://img.youtube.com/vi/XNPECVmpAEM/sddefault.jpg'}
                  alt=""
                  className="override-img"
                  variants={imageVariants}
                />
                <motion.img
                  src={'https://img.youtube.com/vi/V9Rx7KVlzU4/sddefault.jpg'}
                  alt=""
                  className="override-img"
                  variants={imageVariants}
                />
